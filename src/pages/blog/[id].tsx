...
const blogPosts: BlogPost[] = [
  { 
    ...
    content: `
    <h2>Unlocking Insights from My Spotify Streaming History: The Spotistats Project</h2>
    ...
    <h4>Word Cloud of Top 100 Favorite Artists</h4>
    ...
    <p>If you're interested in exploring your Spotify data, you can check out the project on GitHub: <a href="https://github.com/aroramrinaal/spotistats/">https://github.com/aroramrinaal/spotistats/</a></p>
    `,
    date: 'June 6, 2024',
  }
];
